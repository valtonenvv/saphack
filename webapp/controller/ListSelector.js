sap.ui.define([
		...
		return BaseObject.extend("maxipoint.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias maxipoint.model.ListSelector
			 */
			 ...
			 * @return {maxipoint.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
