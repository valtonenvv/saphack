sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("maxipoint/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("maxipoint.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["maxipoint/localService/mockserver"], function (mockserver) {
